...
public class StableMatchingSolver implements MatchingSolver {
    ...
    public ResponseEntity<Response> solve(StableMatchingProblemDTO request) {
        ...
        try {
            ...
            MatchingProblem problem = this.toProblem(request);
    ...
    private MTMProblem toProblem(StableMatchingProblemDTO request) {
    ...
    public ResponseEntity<Response> getInsights(StableMatchingProblemDTO request,
        ...
        MTMProblem problem = this.toProblem(request);
