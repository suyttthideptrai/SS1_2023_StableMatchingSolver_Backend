...
import com.example.SS2_Backend.ss.smt.preference.impl.list.DataSetPreferenceList;
 ...
 */
@Data
public class DataSetPreferenceProvider implements PreferenceBuilder {
     ...
     */
    public DataSetPreferenceProvider(MatchingData matchingData, String[] evaluationFunctions) {
    ...
    public DataSetPreferenceList getPreferenceListByFunction(int index) {
        int set = matchingData.getSetNoOf(index);
        DataSetPreferenceList a;
        Expression e;
        if (set == 0) {
            a = new DataSetPreferenceList(this.sizeOf2, this.sizeOf1);
            ...
            a = new DataSetPreferenceList(this.sizeOf1, 0);
    ...
    public DataSetPreferenceList getPreferenceListByDefault(int index) {
        int set = matchingData.getSetNoOf(index);
        ...
        if (set == 0) {
            ...
            for (int i = 0; i < sizeOf1; i++) {
                ...
                int startRanges = matchingData.getRequirementOfStart()
                // Add
                a.add(totalScore, );
            }
        }
