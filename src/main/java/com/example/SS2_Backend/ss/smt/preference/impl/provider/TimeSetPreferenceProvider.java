 ...
 */
@Data
public class TimeSetPreferenceProvider implements PreferenceBuilder {
     ...
     */
    public TimeSetPreferenceProvider(MatchingData matchingData, String[] evaluationFunctions) {
