...
public class StableMatchingProblem implements Problem {
    ...
    protected List<PreferenceList> preferenceLists; // Preference List of each Individual
    ...
    protected boolean isValidEvaluateFunction(String function) {
    ...
    protected List<PreferenceList> getPreferences() {
