...
public class PreferenceMapProvider {
    ...
    public PreferenceMapProvider(IndividualList individuals) {
    ...
    public PreferenceMap getPreferenceListByFunction(int index) {
        PreferenceMap a = new PreferenceMap(numberOfIndividuals);
        if (individuals.getSetOf(index) == 0) {
            Expression e = this.expressionOfSet1;
            ...
            Expression e = this.expressionOfSet2;
    ...
    public PreferenceMap getPreferenceListByDefault(int index) {
        ...
        if (individuals.getSetOf(index) == 0) {
            for (int i = sizeOf1; i < numberOfIndividuals; i++) {
                ...
                for (int j = 0; j < numberOfProperties; j++) {
                    ...
                    score += getDefaultScaling(requirement, PropertyValue) * PropertyWeight;
                }
                a.put(i, score);
            }
        } else {
