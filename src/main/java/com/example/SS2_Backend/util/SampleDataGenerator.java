...
//        generateSampleIndividualsWithCapacity(
//                2000,
//                1,
//                false,
//                10,
...
//        System.out.println("Number Of Individual: " + problem.getNumberOfIndividuals());
//
//        System.out.println(
...
//            // Testing
//            Testing tester = new Testing(matches, problem.getNumberOfIndividuals(), problem.getIndividualCapacities());
...
//    }
//
//    public static void generateSampleIndividualsWithCapacity(int numSet1, int set1PeakCap, boolean cap1Randomize, int numSet2, int set2PeakCap, boolean cap2Randomize, int numProps) {
